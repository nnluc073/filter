...
func Scope(db *gorm.DB, request *models.FilterReq, dest interface{}) (*database.Paginator, *gorm.DB) {
...
func (s *Settings) Scope(db *gorm.DB, request *models.FilterReq, dest interface{}) (*database.Paginator, *gorm.DB) {
...
func (s *Settings) applyFilters(db *gorm.DB, request *models.FilterReq, schema *schema.Schema) *gorm.DB {
	if s.DisableFilter {
		return db
	}
...
func filterLen(request *models.FilterReq, name string) int {
	count := 0
...
func (s *Settings) applySearch(request *models.FilterReq, schema *schema.Schema) *Search {
